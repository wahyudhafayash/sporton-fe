...
import { getAllCategories } from "@/app/service/category.service";
import { createProduct, updateProduct } from "@/app/service/product.service";
...
const ProductModal = ({
  ...
  const fetchCategories = async () => {
    try {
      ...
      console.log("Failed to fatch categories", error);
    }
  };
